...
function ReviewsForm({ eventSlug, review, onCancel, onSubmitSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    setFormErrors({});
    dispatch(clearErrors()); // Clear Redux errors before submission
    ...
    try {
      ...
      // Set form-level error with better error extraction
      const errorMessage =
